...
public class FutureSetRiskLimit
{
    private readonly HttpClient _httpClient = new();

    public async Task<object> SetRiskLimitAsync(FutureSetRiskLimitRequestEntity requestEntity)
    {
        const string endpoint = $"/api/{ApiConstants.FuturesApiVersion}/risk_limit";
