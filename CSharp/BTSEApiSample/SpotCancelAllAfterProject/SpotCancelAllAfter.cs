...
public class SpotCancelAllAfter
{
    private readonly HttpClient _httpClient = new();

    public async Task<object> CancelAllAfterAsync(SpotCancelAllAfterRequestEntity requestEntity)
    {
        const string endpoint = $"/api/{ApiConstants.SpotApiVersion}/order/cancelAllAfter";
