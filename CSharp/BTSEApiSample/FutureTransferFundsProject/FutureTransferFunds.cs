...
public class FutureTransferFunds
{
    private readonly HttpClient _httpClient = new();

    public async Task<object> TransferFundsAsync(FutureTransferFundsRequestEntity requestEntity)
    {
        const string endpoint = $"/api/{ApiConstants.FuturesApiVersion}/user/wallet/transfer";
