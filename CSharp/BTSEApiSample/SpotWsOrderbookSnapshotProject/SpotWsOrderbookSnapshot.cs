...
namespace SpotWsOrderbookSnapshotProject;

public class SpotWsOrderbookSnapshot
{
    ...
    {
        var subscribe = new WsSubscriptionRequestEntity("subscribe", new[] { "snapshotL1:BTC-USD" });
        await SendAsync(JsonSerializer.Serialize(subscribe));
    }

    public async Task StartListeningAsync()
    {
        var wsUri = new Uri(Utils.GetOssSpotWsUrl());
        try
        {
