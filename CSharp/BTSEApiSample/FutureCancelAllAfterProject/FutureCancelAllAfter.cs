...
public class FutureCancelAllAfter
{
    private readonly HttpClient _httpClient = new();

    public async Task<object> CancelAllAfterAsync(FutureCancelAllAfterRequestEntity requestEntity)
    {
        const string endpoint = $"/api/{ApiConstants.FuturesApiVersion}/order/cancelAllAfter";
