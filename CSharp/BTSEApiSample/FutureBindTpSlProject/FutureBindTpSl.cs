...
public class FutureBindTpSl
{
    private readonly HttpClient _httpClient = new();

    public async Task<object> BindTpSlAsync(FutureBindTpSlRequestEntity requestEntity)
    {
        const string endpoint = $"/api/{ApiConstants.FuturesApiVersion}/order/bind/tpsl";
