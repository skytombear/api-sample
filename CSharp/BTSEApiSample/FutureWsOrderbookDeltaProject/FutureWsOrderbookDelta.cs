...
namespace FutureWsOrderbookDeltaProject;

public class FutureWsOrderbookDelta
{
    ...
    {
        var subscribe = new WsSubscriptionRequestEntity("subscribe", new[] { "update:BTC-PERP_0" });
