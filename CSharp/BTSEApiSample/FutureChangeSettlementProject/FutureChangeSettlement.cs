...
public class FutureChangeSettlement
{
    private readonly HttpClient _httpClient = new();

    public async Task<object> ChangeSettlementAsync(FutureChangeSettlementRequestEntity requestEntity)
    {
        const string endpoint = $"/api/{ApiConstants.FuturesApiVersion}/settle_in";
