...
namespace SpotWsPublicTradeFillsProject;

public class SpotWsPublicTradeFills
{
    ...
    {
        var subscribe = new WsSubscriptionRequestEntity("subscribe", new[] { "tradeHistoryApi:BTC-USD" });
