...
def futures_query_unified_wallet_margin(params):
    url = "/api/{0}/user/unifiedWallet/margin".format(get_futures_api_version())
    env = get_env_info()
...
if __name__ == "__main__":
    print(futures_query_unified_wallet_margin({"symbol": "BTC-PERP"}))
